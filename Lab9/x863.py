...
class cpu:
    ...
    def rdump(self):
        print('REGISTERS::', end=' ')
        print(f'ax: {self.registers[self.REG_AX]}', end=' ')
        print(f'bx: {self.registers[self.REG_BX]}', end=' ')
        print(f'cx: {self.registers[self.REG_CX]}', end=' ')
        print(f'dx: {self.registers[self.REG_DX]}', end=' ')
        print(f'ex: {self.registers[self.REG_EX]}', end=' ')
        print(f'fx: {self.registers[self.REG_FX]}')
        return
